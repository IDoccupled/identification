...
RAW_INPUT = """
 [ 0.8265211   0.4974695   0.50491885  1.68615541  0.15684893 -1.28226814
 -1.94804655 -2.52063384 -1.17846704 -5.14555178  0.1489824  -0.28828445
  0.36775483 -1.00543531  1.00543531 -0.50384089 -1.50815297 -1.44284504
  0.82417668 -0.26623645 -1.11499404  1.22864426  0.54134082  0.93041408
  1.11243544 -1.03678388  2.58164527 -0.73090571 -0.86403137  3.72165632
  4.6520704   4.53975774  0.41123547  0.43915689 -0.49615801 -0.95923355
  0.67669813  0.72084954  0.87127215  1.15057691 -1.48388187  2.25646539
 -0.76045106 -0.49645732 -0.88485849 -0.93041408  0.87457494 -1.50865163
 -0.33048709 -1.49264222  3.61225852  2.30821589  0.92262897 -4.24873833
  0.19120261]
"""

# OUTPUT_NAME = f"pso_balance_{datetime.now().strftime('%y%m%d_%H%M%S')}"
OUTPUT_NAME = f"pso_armature_{datetime.now().strftime('%y%m%d_%H%M%S')}"
# OUTPUT_NAME = f"pso_friction_{datetime.now().strftime('%y%m%d_%H%M%S')}"

OUTPUT_DESC = "Iter: 6, Best fit: [-40.70383545] at"
